...
import { FaRecycle, FaGlobe, FaPhone, FaLinkedin, FaTwitter, FaInstagram } from "react-icons/fa";
...
const About = () => {
  ...
  return (
    <div className="p-8 bg-gradient-to-br from-gray-200 to-gray-100 min-h-screen flex flex-col items-center gap-10 text-gray-900">
      
      {/* Company Title */}
      <h1 className="text-4xl font-extrabold text-center text-gray-800 mb-4">
        About Resource Reclaimers
      </h1>
      ...
      {/* Mission Section */}
      <section className="w-full max-w-5xl flex flex-col md:flex-row items-center gap-8 bg-gray-300 p-6 rounded-lg shadow-lg">
        <FaRecycle className="text-gray-700 text-6xl" />
        <div>
      ...
      {/* Problem Statement */}
      <section className="w-full max-w-5xl flex flex-col md:flex-row-reverse items-center gap-8 bg-gray-300 p-6 rounded-lg shadow-lg">
        <FaGlobe className="text-gray-700 text-6xl" />
        <div>
          <h2 className="text-2xl font-semibold text-gray-800 mb-2">The Problem</h2>
          <p className="text-gray-700 leading-relaxed">
      ...
      {/* Solution Section */}
      <section className="w-full max-w-5xl bg-gray-300 p-6 rounded-lg shadow-lg">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4 text-center">Our Approach</h2>
      ...
      <div className="relative mt-8">
        <button
          ...
          className="p-3 rounded-full bg-gray-700 text-white hover:bg-gray-600 shadow-lg transition-transform transform hover:scale-110"
          title="Contact Us"
        >
          <FaPhone size={22} />
        </button>
        ...
        {isContactOpen && (
          <div className="absolute top-16 left-1/2 transform -translate-x-1/2 bg-gray-300 shadow-xl rounded-lg p-4 flex gap-6 border border-gray-400">
            <a
